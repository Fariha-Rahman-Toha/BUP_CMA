...
<!--navbar ends-->
    <section class="slideshow" >
        <div class="typewriter">
            <h1>Financial and  Managerial Accounting</h1>
          </div>
    </section>
  
    <section id="course">        
        <div class="container">                 
                <iframe src="https://drive.google.com/embeddedfolderview?id=1UZtM0HMN4CMms9ruzSLASbSFQtUe32vg#list"
                width="900px" height="100px" style="background-color:#B2D3C2; "></iframe>   
        </div>
    </section>
