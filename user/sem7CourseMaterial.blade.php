                    ...
                    <div class="navbar-nav">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a href="../user/sem7CourseMaterial.blade.ph" class="dropdown-item">7th Semester</a>
...
<!--navbar ends-->
    ...
    <section id="course">
        ...
        <div class="container">                 
                    <ul>
                        <br/><br/>
                        <li> <a href="#">ICE4100 | Thesis </a></li><br>
                        <li> <a href="#">ICE 4101 | System Analysis & Design </a></li><br>
                        <li> <a href="#">ICE 4103 | Information, Network and Software Security</a></li><br>
                        <li> <a href="#">ICE 4105 | Artificial Intelligence</a></li><br>
                        <li> <a href="#">ICE 4106 | Artificial Intelligence Laboratory</a></li><br>
                        <li> <a href="#">ICE 4107 | Microwave Engineering</a></li><br>
                        <li> <a href="#">ICE 4108 | Microwave Engineering Laboratory</a></li><br>
                        <li> <a href="#">ICE 4109 | Cellular and Mobile Communication</a></li><br>
                        <li> <a href="#">ICE 4110 | Cellular and Mobile Communication Laboratory</a></li>
                    </ul>
        </div>
