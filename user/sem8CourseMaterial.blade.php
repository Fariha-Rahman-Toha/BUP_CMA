...
<!--navbar ends-->
    ...
    <section id="course">
        ...
        <div class="container">                 
                    <ul>
                        <br/><br/>
                        <li> <a href="#">ICE4200 | Comprehensive Viva Voce </a></li><br>
                        <li> <a href="#">ICE 4201 | ICT Project Management </a></li><br>
                        <li> <a href="#">ICE 4202 | ICT Project Management Laboratory</a></li><br>
                        <li> <a href="#">ICE 4203 | Web Engineering</a></li><br>
                        <li><a href="#"> ICE 4204 | Web Engineering Laboratory</a></li><br>
                        <li> <a href="#">ICE 4205 | Multimedia Communication</a></li><br>
                        <li> <a href="#">ICE 4206 | Multimedia Communication Laboratory</a></li><br>
                        <li> <a href="#">ICE 4207 | Information Theory and Coding</a></li><br>
                        <li> <a href="#">ICE 4208 | Information Theory and Coding Laboratory</a></li>
                    </ul>
        </div>
