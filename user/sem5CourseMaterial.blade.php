...
<!--navbar ends-->
    ...
    <section id="course">
        ...
        <div class="container">                 
                    <ul>
                        <br/><br/> <li ><a href="#">Analysis and Design of Algorithm (ICE-3101)</a></li> <br/>
                        <li ><a href="#">Analysis and Design of Algorithm Laboratory (ICE-3102)</a></li><br/>
                        <li ><a href="#">Operating System (ICE-3103)</a></li><br/>
                        <li> <a href="#">ICE 3104 | Operating System Laboratory</a></li><br>
                        <li> <a href="#">ICE 3105 | Digital Communication</a></li><br>
                        <li><a href="#"> ICE 3107 | Digital Signal Processing</a></li><br>
                        <li><a href="#"> ICE 3107 | Digital Signal Processing</a></li><br>
                        <li> <a href="#">ICE 3108 | Digital Signal Processing Laboratory</a></li><br>
                        <li> <a href="#">ICE 3109 | Data Communication & Computer Networks</a></li><br>
                        <li> <a href="#">ICE 3109 | Data Communication & Computer Networks Lab</a></li>
                    </ul>
        </div>
