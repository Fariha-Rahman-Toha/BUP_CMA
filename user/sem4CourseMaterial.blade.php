...
<!--navbar ends-->
    ...
    <section id="course">
        ...
        <div class="container">                 
                    <ul>
                        <br/><br/> <li ><a href="../semester4/ICE2201.blade.php">Mathematics-IV(ICE-2201)</a></li> <br/>
                        <li ><a href="../semester4/ICE2203.blade.php"> Data Structure (ICE-2203)</a></li><br/>
                        <li ><a href="#">Data Structure Lab (ICE-2204)</a></li><br/>
                        <li ><a href="../semester4/ICE2205.blade.php">Database Management Systems (ICE-2205)</a></li><br/>
                        <li ><a href="#">Database Management Systems Laboratory(ICE-2206)</a></li><br/>
                        <li ><a href="../semester4/ICE2207.blade.php">Communication Theory (ICE-2207)</a></li><br/>
                        <li ><a href="#">Communication Theory Lab(ICE-2208)</a></li>
                        <li><a href="../semester4/ICE2209.blade.php">Signals and Systems (ICE-2209)</a></li>
                    </ul>
        </div>
