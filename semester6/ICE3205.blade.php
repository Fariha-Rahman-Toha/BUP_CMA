...
<!--navbar ends-->
    <section class="slideshow" >
        <div class="typewriter">
            <h1>Telecommunication Systems</h1>
          </div>
    </section>
  
    <section id="course">        
        <div class="container">                 
                <iframe src="https://drive.google.com/embeddedfolderview?id=<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
...
<!--navbar ends-->
    ...
    <section id="course">        
        <div class="container">                 
                <iframe src="https://drive.google.com/embeddedfolderview?id=1Wud_5GZI_GDIcOLhuzs7q4rNPoUK2g3o#list"
                width="900px" height="1200px" style="background-color:#B2D3C2; "></iframe>   
        </div>
    </section>
