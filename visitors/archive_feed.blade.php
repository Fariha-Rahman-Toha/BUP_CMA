            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <a href="../visitors/studentprofile.blade.php" class="nav-item nav-link link-light">Profile</a>
                        ...
                        <a href="../visitors/archive_feed.blade.php" class="nav-item nav-link link-light">Archive-Feed</a>
 ...
 <!--navbar ends-->
    ...
    <section class="slideshow" >
        <div class="typewriter">
            <h1>Posts Uploaded by different users</h1>
          </div>
    </section>
