...
<!--navbar ends-->
    ...
    <section id="course">        
        <div class="container">                 
                <iframe src="https://drive.google.com/embeddedfolderview?id=1BIHeqS3gIU9-KHQbjmWrnxAwzT2RkUgi#list"
                width="900px" height="150px" style="background-color:#B2D3C2; "></iframe>   
        </div>
    </section>
