...
<!--navbar ends-->
    ...
    <section id="course">        
        <div class="container">                 
                <iframe src="https://drive.google.com/embeddedfolderview?id=15acX75X6OQAus8upvbQLuG-RTXsmqXFl#list"
                width="900px" height="1150px" style="background-color:#B2D3C2; "></iframe>   
        </div>
    </section>
